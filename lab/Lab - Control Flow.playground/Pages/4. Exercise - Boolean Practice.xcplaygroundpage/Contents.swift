...
if !isRaining || (temp >= 82 && !isWindy) {
    ...
    print("I am not going for a walk.")
}
//insert print statements here!!
print("I am going for a walk for the first set of conditions.")
print("I am not going for a walk for the second set of conditions.")
print("I am not going for a walk for the third set of conditions.")
